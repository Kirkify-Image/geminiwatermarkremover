...
**Gemini Watermark Remover** is a free, privacy-first web app for removing the Gemini export watermark from original Gemini-generated images. It runs locally in the browser, avoids server-side image uploads, and is built on top of the open-source [`@pilio/gemini-watermark-remover`](https://www.npmjs.com/package/@pilio/gemini-watermark-remover) engine.

Live site: [https://gemini-watermarkremover.org/](https://gemini-watermarkremover.org/)
...
1. Upload an original Gemini export in PNG, JPG, or WebP format.
2. The browser processes the file locally using the Gemini watermark engine.
3. Reverse Alpha Blending reconstructs the marked region.
4. You compare the result and download a clean PNG.
...
- [https://gemini-watermarkremover.org/](https://gemini-watermarkremover.org/)
...
- Watermark engine: [`@pilio/gemini-watermark-remover`](https://www.npmjs.com/package/@pilio/gemini-watermark-remover)
